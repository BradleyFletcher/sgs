...
<?php while (have_posts()) : the_post(); ?>
  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <!-- Page Header -->
    <header class="relative bg-primary-900 text-white py-16 md:py-20 overflow-hidden">
      <?php if (has_post_thumbnail()) : ?>
        ...
        <!-- Dark Overlay -->
        <div class="absolute inset-0 bg-gradient-to-r from-primary-900/95 via-primary-900/85 to-primary-900/75"></div>
      <?php else : ?>
        <!-- Pattern Overlay (fallback if no featured image) -->
